      ...
      <form action="novedades-mod.php?id=<?= $idEsc ?>" method="POST" class="card border-0 shadow-sm p-4 p-md-5"
        ...
        <div class="mb-3">
          ...
          <textarea
            id="textoNovedad"
            name="textoNovedad"
            class="form-control<?= $campoError === 'textoNovedad' ? ' is-invalid' : '' ?>"
            rows="4"
            maxlength="200"
            required
        ...
        <div class="row g-3">
          <div class="col-md-6">
            ...
            <input
              ...
              class="form-control<?= $campoError === 'fechaPublicacionNovedad' ? ' is-invalid' : '' ?>
...
<?php endif; ?>"
          ...
          <div class="col-md-6">
            ...
            <input
              ...
              class="form-control<?= $campoError === 'fechaExpiracionNovedad' ? ' is-invalid' : '' ?>
