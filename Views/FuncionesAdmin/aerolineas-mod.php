        ...
        <form action="aerolineas-mod.php?id=<?= $idEsc ?>" method="POST" class="card border-0 shadow-sm p-4 p-md-5"
          ...
          <div class="mb-3">
            ...
            <input
              ...
              class="form-control<?= $campoError === 'nombreAerolinea' ? ' is-invalid' : '' ?>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input
                ...
                id="codigoIATA"
                name="codigoIATA"
                class="form-control text-uppercase<?= $campoError === 'codigoIATA' ? ' is-invalid' : '' ?>
...
<?php endif; ?>"
            ...
            <div class="col-md-6">
              ...
              <input
                ...
                id="codigoPais"
                name="codigoPais"
                class="form-control text-uppercase<?= $campoError === 'codigoPais' ? ' is-invalid' : '' ?>
...
<?php endif; ?>"
          ...
          <div class="mb-3 mt-3">
            ...
            <textarea
              ...
              class="form-control<?= $campoError === 'descripcionAerolinea' ? ' is-invalid' : '' ?>"
              rows="3"
              maxlength="200"
              required
