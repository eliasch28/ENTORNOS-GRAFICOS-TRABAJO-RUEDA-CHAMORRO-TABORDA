...
if (!$sinAerolinea) {
  ...
  $resReservas = mysqli_query(
    $link,
    "SELECT r.codReserva, r.estadoReserva, r.fechaReserva, r.cantidadPasajes,
                        ...
                        <table class="table table-hover align-middle mb-0 small">
                          <thead class="table-light">
                            <tr>
                              ...
                              <th scope="col" class="text-center">Cant. Pasajes</th>
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                ...
                                <td class="text-center fw-semibold"><?= (int)$res['cantidadPasajes'] ?></td>
                                <td><?= $fechaResFmt ?></td>
