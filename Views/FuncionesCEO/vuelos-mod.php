...
$resU = mysqli_query(
  $link,
  "SELECT u.codAerolinea, a.nombreAerolinea, a.codigoIATA
     FROM USUARIOS u
...
$vuelo = ($resV && mysqli_num_rows($resV) > 0)
  ? mysqli_fetch_assoc($resV)
  : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  /*
     * Si hubo un error de validación, mantenemos los datos
     * que el usuario había ingresado en el formulario.
     */
  ...
  $vuelo['horaSalidaVuelo']     = $_POST['horaSalidaVuelo'] ?? $vuelo['horaSalidaVuelo'];
...
<head>
  ...
  <title>Editar Vuelo | VuelaLibre – UTN FRR</title>
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
          <div>
            ...
            <h1 class="h3 fw-bold mb-0">
              Editar Vuelo
              <small class="text-secondary fs-5">#<?= $codFmt ?></small>
            </h1>
          </div>
          ...
          <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <form
                  action="vuelos-mod.php?id=<?= $codVuelo ?>"
                  method="post"
                  aria-label="Formulario de edición de vuelo">
                  ...
                  <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-text">
                        Podés ajustar la cantidad según la disponibilidad.
                      </div>
                    </div>
