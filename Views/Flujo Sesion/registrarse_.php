...
<head>
  ...
  <meta name="description" content="Creá tu cuenta en SkyReserva para buscar y reservar vuelos." />
        ...
        <div class="row justify-content-center">
          <div class="col-md-8 col-lg-6">
            ...
            <div class="text-center mb-4">
              ...
              <p class="text-secondary">Completá el formulario para registrarte en SkyReserva.</p>
            </div>
